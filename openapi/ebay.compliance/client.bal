...
# This eBay Compliance Service is for providing information to sellers about their listings being non-compliant, 
# or at risk for becoming non-compliant, against eBay listing policies.
#
...
public client class Client {
    ...
    # 
    # Create an [eBay account](https://www.ebay.com/) and obtain tokens following 
    # [this guide](https://developer.ebay.com/DevZone/XML/docs/HowTo/Tokens/GettingTokens.html). 
    # 
    # Configure the API key to have the [required permission](https://developer.ebay.com/api-docs/static/oauth-scopes.html).
    #
