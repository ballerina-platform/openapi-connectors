...
public isolated client class Client {
    ...
    #
    # + return - 200 
    remote isolated function deleteCategoryByID(string projectKey, string id, float 'version, Expansion[]? expand = ()) returns Category|error {
        string resourcePath = string `/${projectKey}/categories/${id}`;
    ...
    #
    # + return - 200 
    remote isolated function queryCategory(string projectKey, Expansion[]? expand = (), Sort[]? sort = (), float? 'limit = (), float? offset = (), boolean? withTotal = (), QueryPredicate[]? 'where = (), string[]? varAZaZ09 = ()) returns CategoryPagedQueryResponse|error {
    ...
    #
    # + return - 200 
    remote isolated function deleteCategoryByKey(string projectKey, string 'key, float 'version, Expansion[]? expand = ()) returns Category|error {
        string resourcePath = string `/${projectKey}/categories/key=${'key}`;
        map<anydata> queryParam = {"version": 'version, "expand": expand};
        map<Encoding> queryParamEncoding = {"expand": {style: FORM, explode: true}};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam, queryParamEncoding);
    ...
    #
    # + return - 200 
    remote isolated function deleteProductByID(string projectKey, string id, float 'version, string? priceCurrency = (), string? priceCountry = (), string? priceCustomerGroup = (), string? priceChannel = (), string? localeProjection = (), string? storeProjection = (), Expansion[]? expand = ()) returns Product|error {
        string resourcePath = string `/${projectKey}/products/${id}`;
    ...
    #
    # + return - 200 
    remote isolated function queryProductSelectionsForProductByKey(string projectKey, string 'key, Expansion[]? expand = (), Sort[]? sort = (), float? 'limit = (), float? offset = (), boolean? withTotal = (), QueryPredicate[]? 'where = (), string[]? varAZaZ09 = ()) returns ProductSelectionPagedQueryResponse|error {
    ...
    #
    # + return - 200 
    remote isolated function queryProductSelectionsForProductByID(string projectKey, string id, Expansion[]? expand = (), Sort[]? sort = (), float? 'limit = (), float? offset = (), boolean? withTotal = (), QueryPredicate[]? 'where = (), string[]? varAZaZ09 = ()) returns ProductSelectionPagedQueryResponse|error {
    ...
    #
    # + return - 200 
    remote isolated function deleteProductByKey(string projectKey, string 'key, float 'version, string? priceCurrency = (), string? priceCountry = (), string? priceCustomerGroup = (), string? priceChannel = (), string? localeProjection = (), string? storeProjection = (), Expansion[]? expand = ()) returns Product|error {
        string resourcePath = string `/${projectKey}/products/key=${'key}`;
        map<anydata> queryParam = {"priceCurrency": priceCurrency, "priceCountry": priceCountry, "priceCustomerGroup": priceCustomerGroup, "priceChannel": priceChannel, "localeProjection": localeProjection, "storeProjection": storeProjection, "version": 'version, "expand": expand};
        map<Encoding> queryParamEncoding = {"expand": {style: FORM, explode: true}};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam, queryParamEncoding);
    ...
    #
    # + return - 200 
    remote isolated function uploadProductImage(string projectKey, string id, byte[] payload, string? filename = (), float? variant = (), string? sku = (), boolean? staged = ()) returns Product|error {
    ...
    #
    # + return - 200 
    remote isolated function deleteProductSelectionByID(string projectKey, string id, float 'version, Expansion[]? expand = ()) returns ProductSelection|error {
        string resourcePath = string `/${projectKey}/product-selections/${id}`;
        map<anydata> queryParam = {"version": 'version, "expand": expand};
        map<Encoding> queryParamEncoding = {"expand": {style: FORM, explode: true}};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam, queryParamEncoding);
    ...
    #
    # + return - 200 
    remote isolated function deleteProductSelectionsByKey(string projectKey, string 'key, float 'version, Expansion[]? expand = ()) returns ProductSelection|error {
        string resourcePath = string `/${projectKey}/product-selections/key=${'key}`;
        map<anydata> queryParam = {"version": 'version, "expand": expand};
        map<Encoding> queryParamEncoding = {"expand": {style: FORM, explode: true}};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam, queryParamEncoding);
    ...
    #
    # + return - 200 
    remote isolated function queryProductsAssignedProductSelectionByKey(string projectKey, string 'key, Expansion[]? expand = (), float? 'limit = (), float? offset = (), boolean? withTotal = ()) returns ProductSelectionProductPagedQueryResponse|error {
    ...
    #
    # + return - 200 
    remote isolated function queryProductsAssignedProductSelectionByID(string projectKey, string id, Expansion[]? expand = (), float? 'limit = (), float? offset = (), boolean? withTotal = ()) returns ProductSelectionProductPagedQueryResponse|error {
    ...
    #
    # + return - 200 
    remote isolated function suggestQuery(string projectKey, boolean? fuzzy = (), boolean? staged = (), string[]? searchkeywordsAZ2AZ2 = (), Sort[]? sort = (), float? 'limit = (), float? offset = (), boolean? withTotal = ()) returns json|error {
    ...
    #
    # + return - 200 
    remote isolated function deleteInventoryEntryByID(string projectKey, string id, float 'version, Expansion[]? expand = ()) returns InventoryEntry|error {
        string resourcePath = string `/${projectKey}/inventory/${id}`;
        map<anydata> queryParam = {"version": 'version, "expand": expand};
        map<Encoding> queryParamEncoding = {"expand": {style: FORM, explode: true}};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam, queryParamEncoding);
    ...
    #
    # + return - 200 
    remote isolated function queryInventory(string projectKey, Expansion[]? expand = (), Sort[]? sort = (), float? 'limit = (), float? offset = (), boolean? withTotal = (), QueryPredicate[]? 'where = (), string[]? varAZaZ09 = ()) returns InventoryPagedQueryResponse|error {
    ...
    #
    # + return - 200 
    remote isolated function deleteReviewByID(string projectKey, string id, float 'version, boolean? dataErasure = (), Expansion[]? expand = ()) returns Review|error {
        string resourcePath = string `/${projectKey}/reviews/${id}`;
    ...
    #
    # + return - 200 
    remote isolated function deleteReviewByKey(string projectKey, string 'key, float 'version, boolean? dataErasure = (), Expansion[]? expand = ()) returns Review|error {
        string resourcePath = string `/${projectKey}/reviews/key=${'key}`;
        map<anydata> queryParam = {"dataErasure": dataErasure, "version": 'version, "expand": expand};
        map<Encoding> queryParamEncoding = {"expand": {style: FORM, explode: true}};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam, queryParamEncoding);
    ...
    #
    # + return - 200 
    remote isolated function queryReviews(string projectKey, Expansion[]? expand = (), Sort[]? sort = (), float? 'limit = (), float? offset = (), boolean? withTotal = (), QueryPredicate[]? 'where = (), string[]? varAZaZ09 = ()) returns ReviewPagedQueryResponse|error {
