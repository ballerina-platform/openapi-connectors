...
public type InlineResponse2002Fields record {
    # Field Id
    string? id?;
    # Field name
    string? 'field?;
...
public type InlineResponse2008Data record {
    ...
    InlineResponse2008Values[]? values?;
};
...
public type InlineResponse2008Values record {
    int? field_id?;
    string? value?;
};
...
public type InlineResponse2002 record {
    ...
    InlineResponse2002Details[]? details?;
};
...
public type InlineResponse2002Details record {
    int? id?;
    string? name?;
    string? 'type?;
    # Record Id
    int? 'record?;
    InlineResponse2002Fields[]? fields?;
};
...
public type InlineResponse2009Data record {
    # Note Id
    int? id?;
    # Pin note to top
    string? sticky?;
...
public type InlineResponse20019Tab record {
    int? id?;
    string? name?;
};
...
public type InlineResponse20019Data record {
    # Document Id
    string? id?;
    # Name
    string? name?;
    # Size
    string? size?;
    InlineResponse20019Tab? tab?;
    InlineResponse20019Label? label?;
};
...
public type InlineResponse20014Data record {
    # Task Id
    int? id?;
    BriefUserInfo? user?;
    # Task description
...
public type InlineResponse20019Label record {
    int? id?;
    string? name?;
};
