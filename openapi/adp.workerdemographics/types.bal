...
public type OtherPersonalAddressDemographicType record {
...
# A logical operation
public type WorkerdemographicsmetaLogicaloperators record {
    # A simple (string) code.  Can have a code list reference
...
public type WorkAssignmentReportsToDemographicType record {
...
public type WorkerGroupDemographicType record {
    # The code for the related entity.  If this is a coded value, codeValue and shortName should be used. If this is just a string value, only shortName is necessary
    CodetypeV02 nameCode?;
    # The code for the related entity.  If this is a coded value, codeValue and shortName should be used. If this is just a string value, only shortName is necessary
...
public type WorkerdemographicPhotos record {
    # The code for the related entity.  If this is a coded value, codeValue and shortName should be used. If this is just a string value, only shortName is necessary
    CodetypeV02 nameCode?;
    LinktypeV02[] links?;
    # The unique identifier of the object in a collection
...
public type RaceCodeDemographicType record {
    # The code for the related entity
    string codeValue?;
    # Short description of the related code
    string shortName?;
...
public type WorkerDemographic record {
    Workerdemographic1[] workers?;
...
# Object describing the details of a person demographic
public type PersondemographictypeV02 record {
...
# An object describing the a restricted  set of details of a work assignment. A work assignment pertains to the duties and responsibilities that should be performed by the worker
public type WorkerdemographicWorkassignments record {
    # Boolean expression
    ...
    WorkerGroupDemographicType[] workerGroups?;
    # The code for the related entity.  If this is a coded value, codeValue and shortName should be used. If this is just a string value, only shortName is necessary
    CodetypeV02 jobCode?;
    # The job title
    string jobTitle?;
    ...
    OccupationalClassificationDemographicType[] occupationalClassifications?;
    ...
    OccupationalClassificationDemographicType[] industryClassifications?;
    ...
    HomeOrganizationalUnitDemographicType[] homeOrganizationalUnits?;
    # A list of organizational units
    AssignedOrganizationalUnitDemographicType[] assignedOrganizationalUnits?;
    # Schema to describe details of a location
    LocationtypeV02 homeWorkLocation?;
    # A list of work locations
    AssignedWorkLocationDemographicType[] assignedWorkLocations?;
    # The code for the related entity.  If this is a coded value, codeValue and shortName should be used. If this is just a string value, only shortName is necessary
    ...
    WorkAssignmentReportsToDemographicType[] reportsTo?;
    # Status to include the status code and effective date (ISO-8601:2000 format)
...
public type FormerNameDemographicType record {
    # The first name of the person
    string givenName?;
    # Person middle name or initial
    string middleName?;
...
public type WorkerDemographicsMeta record {
    # A collection of query criteria
    WorkerDemographicsQueryCriterion[] queryCriteria?;
    ArrayType '\/workers?;
...
public type AssignedWorkLocationDemographicType record {
    # The code for the related entity.  If this is a coded value, codeValue and shortName should be used. If this is just a string value, only shortName is necessary
    CodetypeV02 nameCode?;
    # Communication objects to include various communication mechanisms, e,g, phone, email, etc.
    CommunicationtypeV02 communication?;
...
public type AssignedOrganizationalUnitDemographicType record {
    # The code for the related entity.  If this is a coded value, codeValue and shortName should be used. If this is just a string value, only shortName is necessary
    CodetypeV02 nameCode?;
    # The code for the related entity.  If this is a coded value, codeValue and shortName should be used. If this is just a string value, only shortName is necessary
    CodetypeV02 typeCode?;
...
public type AlternatePreferredNameDemographicType record {
    # The first name of the person
    string givenName?;
    # Person middle name or initial
    string middleName?;
...
public type Workerdemographic1 record {
    # The unique identifier of an assoicate
    AssociateoidtypeV02 associateOID?;
    # The unique identifier of the related entity 
    IdtypeV02 workerID?;
    # Object describing the details of a person demographic
    PersondemographictypeV02 person?;
    ...
    WorkerdemographicWorkerdates workerDates?;
    # Status to include the status code, effective date (ISO-8601:2000 format) and the reason for change
    StatusreasontypeV02 workerStatus?;
    # A list of photos
    WorkerdemographicPhotos[] photos?;
    # Communication objects to include various communication mechanisms, e,g, phone, email, etc.
    CommunicationtypeV02 businessCommunication?;
    WorkerdemographicWorkassignments[] workAssignments?;
    # A container of custom fields. The category within each custom object allows for the categorizing or grouping of the associated custom field for the purpose of data mining. For example, the typeCode on a custom string object might be valued as SIZE and the correlating name codes might be t-shirt, pants, jacket, etc.
    CustomfieldcontainertypeV02 customFieldGroup?;
    LinktypeV02[] links?;
};
...
# These dates are related to the highest level legal relationship that a person has with the organization. If a given worker has multiple relationships with the organization, these are the dates associated with the primary relationship.
public type WorkerdemographicWorkerdates record {
    # The string representation of the date value. Follows the ISO-8601:2000 format
...
public type WorkerDemographicsMetaType record {
    WorkerDemographicsMeta meta?;
};
...
public type WorkerDemographicsQueryCriterion record {
    # A simple (string) code.  Can have a code list reference
    ...
    WorkerdemographicsmetaLogicaloperators[] logicalOperators?;
    # The unique identifier of the object in a collection
    ItemidtypeV01 itemID?;
};
...
public type OccupationalClassificationDemographicType record {
    # The code for the related entity.  If this is a coded value, codeValue and shortName should be used. If this is just a string value, only shortName is necessary
    CodetypeV02 nameCode?;
    # The code for the related entity.  If this is a coded value, codeValue and shortName should be used. If this is just a string value, only shortName is necessary
...
public type HomeOrganizationalUnitDemographicType record {
    # The code for the related entity.  If this is a coded value, codeValue and shortName should be used. If this is just a string value, only shortName is necessary
    CodetypeV02 nameCode?;
    # The code for the related entity.  If this is a coded value, codeValue and shortName should be used. If this is just a string value, only shortName is necessary
    CodetypeV02 typeCode?;
