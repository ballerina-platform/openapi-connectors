...
public isolated client class Client {
    ...
    public isolated function init(ConnectionConfig config, string serviceUrl = "https://api.ebay.com/sell/inventory/v1") returns error? {
    ...
    remote isolated function bulkCreateOrReplaceInventoryItem(BulkInventoryItem payload) returns BulkInventoryItemResponse|error? {
        string resourcePath = string `/bulk_create_or_replace_inventory_item`;
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        BulkInventoryItemResponse? response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    remote isolated function bulkGetInventoryItem(BulkGetInventoryItem payload) returns BulkGetInventoryItemResponse|error? {
        string resourcePath = string `/bulk_get_inventory_item`;
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        BulkGetInventoryItemResponse? response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    remote isolated function bulkUpdatePriceQuantity(BulkPriceQuantity payload) returns BulkPriceQuantityResponse|error? {
        string resourcePath = string `/bulk_update_price_quantity`;
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        BulkPriceQuantityResponse? response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    remote isolated function getInventoryItems(string? 'limit = (), string? offset = ()) returns InventoryItems|error {
        string resourcePath = string `/inventory_item`;
        map<anydata> queryParam = {"limit": 'limit, "offset": offset};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        InventoryItems response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    remote isolated function bulkMigrateListing(BulkMigrateListing payload) returns BulkMigrateListingResponse|error? {
        string resourcePath = string `/bulk_migrate_listing`;
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        BulkMigrateListingResponse? response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    remote isolated function bulkCreateOffer(BulkEbayOfferDetailsWithKeys payload) returns BulkOfferResponse|error? {
        string resourcePath = string `/bulk_create_offer`;
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        BulkOfferResponse? response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    remote isolated function bulkPublishOffer(BulkOffer payload) returns BulkPublishResponse|error? {
        string resourcePath = string `/bulk_publish_offer`;
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        BulkPublishResponse? response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    remote isolated function getOffers(string? format = (), string? 'limit = (), string? marketplaceId = (), string? offset = (), string? sku = ()) returns Offers|error {
        string resourcePath = string `/offer`;
    ...
    remote isolated function getListingFees(OfferKeysWithId payload) returns FeesSummaryResponse|error {
        string resourcePath = string `/offer/get_listing_fees`;
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        FeesSummaryResponse response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    remote isolated function publishOfferByInventoryItemGroup(PublishByInventoryItemGroupRequest payload) returns PublishResponse|error {
        string resourcePath = string `/offer/publish_by_inventory_item_group/`;
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        PublishResponse response = check self.clientEp->post(resourcePath, request);
    ...
    remote isolated function withdrawOfferByInventoryItemGroup(WithdrawByInventoryItemGroupRequest payload) returns http:Response|error {
        string resourcePath = string `/offer/withdraw_by_inventory_item_group`;
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
