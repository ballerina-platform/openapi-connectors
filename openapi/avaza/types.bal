...
public type UserDetails record {
    ...
    float? DefaultCostRate?;
    float? MondayAvailableHours?;
    float? TuesdayAvailableHours?;
    float? WednesdayAvailableHours?;
    float? ThursdayAvailableHours?;
    float? FridayAvailableHours?;
    float? SaturdayAvailableHours?;
    float? SundayAvailableHours?;
    RoleDetails[]? Roles?;
    UserTagDetails[]? Tags?;
};
...
public type ExpenseDetails record {
    ...
    float? ExpenseCategoryUnitPrice?;
