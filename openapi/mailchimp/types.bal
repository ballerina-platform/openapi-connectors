...
public type InlineResponse2008 record {
    record {
        ...
        record {
            ...
            record {int gender?; int min_age?; int max_age?; record {string[] countries?; string[] regions?; string[] cities?; string[] zips?;} locations?; record {string name?;}[] interests?;} targeting_specs?;
        } audience?;
        record {
        ...
        record {string title?; string link_url?; string message?; string description?; string image_url?; string call_to_action?; record {string name?; string link_url?; string description?; string image_url?; string call_to_action?;}[] attachments?;} content?;
        # A list of link types and descriptions for the API schema documents.
        record {
...
public type SubscriberList2 record {
    ...
    string notify_on_subscribe = "false";
    # The email address to send [unsubscribe notifications](https://mailchimp.com/help/change-subscribe-and-unsubscribe-notifications/) to.
    string notify_on_unsubscribe = "false";
    ...
    boolean double_optin = false;
    # Whether or not the list has marketing permissions (eg. GDPR) enabled.
    boolean marketing_permissions = false;
};
