...
# The Flat API allows you to easily extend the abilities of the [Flat Platform](https://flat.io). 
# Flat is a powerful cloud-based notation software that let you to create music scores and guitar tabs. 
public isolated client class Client {
    final http:Client clientEp;
    # Gets invoked to initialize the `connector`.
    # The connector initialization requires setting the API credentials.
    # Create an [Flat Platform Account](https://flat.io/auth/signup) 
    # and obtain tokens following [this guide](https://flat.io/developers/docs/api/authentication.html).
    #
