...
public isolated client class Client {
    ...
    remote isolated function getAuthorizedApps(string[]? fields = (), string[]? excludeFields = (), int count = 10, int offset = 0) returns InlineResponse200|error {
    ...
    remote isolated function getAuthorizedAppsId(string appId, string[]? fields = (), string[]? excludeFields = ()) returns InlineResponse2001|error {
    ...
    remote isolated function getAutomations(int count = 10, int offset = 0, string[]? fields = (), string[]? excludeFields = (), string? beforeCreateTime = (), string? sinceCreateTime = (), string? beforeStartTime = (), string? sinceStartTime = (), string? status = ()) returns InlineResponse2002|error {
    ...
    remote isolated function getAutomationsIdEmailsIdQueue(string workflowId, string workflowEmailId) returns InlineResponse2003|error {
