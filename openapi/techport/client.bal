...
public isolated client class Client {
    ...
    public isolated function init(ConnectionConfig config =  {}, string serviceUrl = "https://techport.nasa.gov") returns error? {
    ...
    remote isolated function getProject(int projectId) returns Project|error {
        string resourcePath = string `/api/projects/${getEncodedUri(projectId)}`;
