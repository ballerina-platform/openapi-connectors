...
@display {label: "Vonage SMS", iconPath: "icon.png"}
public isolated client class Client {
    ...
    public isolated function init(ConnectionConfig config =  {}, string serviceUrl = "https://rest.nexmo.com/sms") returns error? {
