...
public isolated client class Client {
    ...
    #
    # + apiKeyConfig - Provide your API key as `api_token`. Eg: `{"api_token" : "<API key>"}`
    ...
    remote isolated function getActivities(int? userId = (), int? filterId = (), string? 'type = (), int? 'limit = (), int? 'start = (), string? startDate = (), string? endDate = (), decimal? done = ()) returns GetActivitiesResponse200|error {
        ...
        map<anydata> queryParam = {"user_id": userId, "filter_id": filterId, "type": 'type, "limit": 'limit, "start": 'start, "start_date": startDate, "end_date": endDate, "done": done, "api_token": self.apiKeys["api_token"]};
    ...
    remote isolated function addActivity(AddActivityRequest payload) returns AddActivityResponse200|error {
        string  path = string `/activities`;
        map<anydata> queryParam = {"api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteActivities(string ids) returns DeleteActivitiesResponse200|error {
        string  path = string `/activities`;
        map<anydata> queryParam = {"ids": ids, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteActivitiesResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteActivitiesResponse200);
        return response;
    }
    ...
    remote isolated function deleteActivity(int id) returns DeleteActivityResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteActivityResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteActivityResponse200);
        return response;
    }
    ...
    remote isolated function deleteActivityTypes(string ids) returns DeleteActivityTypesResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteActivityTypesResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteActivityTypesResponse200);
        return response;
    }
    ...
    remote isolated function deleteActivityType(int id) returns CreateUpdateDeleteActivityTypeResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        CreateUpdateDeleteActivityTypeResponse200 response = check self.clientEp-> delete(path, request, targetType = CreateUpdateDeleteActivityTypeResponse200);
        return response;
    }
    ...
    remote isolated function getUserCallLogs(decimal? 'limit = (), decimal? 'start = ()) returns GetUserCallLogsResponse200|error {
        ...
        map<anydata> queryParam = {"limit": 'limit, "start": 'start, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteCallLog(string id) returns DeleteCallLogResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteCallLogResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteCallLogResponse200);
        return response;
    }
    # Attach an audio file to the call log
    #
    # + id - The ID received when you create the call log
    # + payload - AddCallLogAudioFile request
    # + return - The audio recording was successfully added to the log.
    remote isolated function addCallLogAudioFile(string id, AddCallLogAudioFileRequest payload) returns AddCallLogAudioFileResponse200|error {
        string  path = string `/callLogs/${id}/recordings`;
        map<anydata> queryParam = {"api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
        http:Request request = new;
        AddCallLogAudioFileResponse200 response = check self.clientEp->post(path, request, targetType=AddCallLogAudioFileResponse200);
        return response;
    }
    ...
    remote isolated function getCurrencies(string? term = ()) returns GetCurrenciesResponse200|error {
        ...
        map<anydata> queryParam = {"term": term, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function getDeals(int? userId = (), int? filterId = (), int? stageId = (), string status = "all_not_deleted", int 'start = 0, int? 'limit = (), string? sort = (), decimal? ownedByYou = ()) returns GetDealsResponse200|error {
        ...
        map<anydata> queryParam = {"user_id": userId, "filter_id": filterId, "stage_id": stageId, "status": status, "start": 'start, "limit": 'limit, "sort": sort, "owned_by_you": ownedByYou, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteDeals(string ids) returns DeleteDealsResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteDealsResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteDealsResponse200);
        return response;
    }
    # Search deals
    #
    ...
    remote isolated function searchDeals(string term, string? fields = (), boolean? exactMatch = (), int? personId = (), int? organizationId = (), string? status = (), string? includeFields = (), int 'start = 0, int? 'limit = ()) returns SearchDealsResponse200|error {
        ...
        map<anydata> queryParam = {"term": term, "fields": fields, "exact_match": exactMatch, "person_id": personId, "organization_id": organizationId, "status": status, "include_fields": includeFields, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function getDealsByName(string term, int? personId = (), int? orgId = ()) returns GetDealsByNameResponse200|error {
        ...
        map<anydata> queryParam = {"term": term, "person_id": personId, "org_id": orgId, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function getDealsSummary(string? status = (), int? filterId = (), int? userId = (), int? stageId = ()) returns GetDealsSummaryResponse200|error {
        ...
        map<anydata> queryParam = {"status": status, "filter_id": filterId, "user_id": userId, "stage_id": stageId, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function getDealsTimeline(string startDate, string interval, int amount, string fieldKey, int? userId = (), int? pipelineId = (), int? filterId = (), decimal? excludeDeals = (), string? totalsConvertCurrency = ()) returns GetDealsTimelineResponse200|error {
        ...
        map<anydata> queryParam = {"start_date": startDate, "interval": interval, "amount": amount, "field_key": fieldKey, "user_id": userId, "pipeline_id": pipelineId, "filter_id": filterId, "exclude_deals": excludeDeals, "totals_convert_currency": totalsConvertCurrency, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteDeal(int id) returns DeleteDealResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteDealResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteDealResponse200);
        return response;
    }
    ...
    remote isolated function getDealActivities(int id, int 'start = 0, int? 'limit = (), decimal? done = (), string? exclude = ()) returns GetDealActivitiesResponse200|error {
        ...
        map<anydata> queryParam = {"start": 'start, "limit": 'limit, "done": done, "exclude": exclude, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function getDealFiles(int id, int 'start = 0, int? 'limit = (), decimal? includeDeletedFiles = (), string? sort = ()) returns GetAssociatedFilesResponse200|error {
        ...
        map<anydata> queryParam = {"start": 'start, "limit": 'limit, "include_deleted_files": includeDeletedFiles, "sort": sort, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function getDealUpdates(int id, int 'start = 0, int? 'limit = (), string? allChanges = (), string? items = ()) returns GetDealUpdatesResponse200|error {
        ...
        map<anydata> queryParam = {"start": 'start, "limit": 'limit, "all_changes": allChanges, "items": items, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteDealFollower(int id, int followerId) returns DeleteDealFollowerResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteDealFollowerResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteDealFollowerResponse200);
        return response;
    }
    ...
    remote isolated function getDealMailMessages(int id, int 'start = 0, int? 'limit = ()) returns GetAssociatedMailMessagesResponse200|error {
        ...
        map<anydata> queryParam = {"start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteDealParticipant(int id, int dealParticipantId) returns DeleteDealParticipantResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteDealParticipantResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteDealParticipantResponse200);
        return response;
    }
    ...
    remote isolated function getDealProducts(int id, int 'start = 0, int? 'limit = (), decimal? includeProductData = ()) returns ListProductsResponse200|error {
        ...
        map<anydata> queryParam = {"start": 'start, "limit": 'limit, "include_product_data": includeProductData, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteDealProduct(int id, int productAttachmentId) returns DeleteDealProductResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteDealProductResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteDealProductResponse200);
        return response;
    }
    # Get all deal fields
    #
    ...
    remote isolated function deleteDealFields(string ids) returns DeleteFieldsResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteFieldsResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteFieldsResponse200);
        return response;
    }
    # Get one deal field
    #
    ...
    remote isolated function deleteDealField(int id) returns DeleteFieldResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteFieldResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteFieldResponse200);
        return response;
    }
    # Get all files
    #
    ...
    # Add file
    #
    # + payload - AddFile request
    # + return - Add a file from computer or Google Drive and associate it with Deal, Person, Organization, Activity or Product.
    remote isolated function addFile(AddFileRequest payload) returns AddFileResponse200|error {
        string  path = string `/files`;
        map<anydata> queryParam = {"api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
        http:Request request = new;
        AddFileResponse200 response = check self.clientEp->post(path, request, targetType=AddFileResponse200);
        return response;
    }
    ...
    remote isolated function deleteFile(int id) returns DeleteFileResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteFileResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteFileResponse200);
        return response;
    }
    # Download one file
    #
    ...
    remote isolated function getFilters(string? 'type = ()) returns GetFiltersResponse200|error {
        ...
        map<anydata> queryParam = {"type": 'type, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteFilters(string ids) returns DeleteFiltersResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteFiltersResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteFiltersResponse200);
        return response;
    }
    ...
    remote isolated function deleteFilter(int id) returns DeleteFilterResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteFilterResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteFilterResponse200);
        return response;
    }
    # Get global messages
    #
    ...
    remote isolated function getGlobalMessages(int 'limit = 1) returns GetGlobalMessagesResponse200|error {
        ...
        map<anydata> queryParam = {"limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteGlobalMessage(int id) returns DeleteGlobalMessageResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteGlobalMessageResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteGlobalMessageResponse200);
        return response;
    }
    # Add a new goal
    #
    ...
    remote isolated function deleteGoal(string id) returns DeleteGoalResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteGoalResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteGoalResponse200);
        return response;
    }
    ...
    remote isolated function getGoalResult(string id, string periodStart, string periodEnd) returns GetGoalResultResponse200|error {
        ...
        map<anydata> queryParam = {"period.start": periodStart, "period.end": periodEnd, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function searchItem(string term, string? itemTypes = (), string? fields = (), boolean? searchForRelatedItems = (), boolean? exactMatch = (), string? includeFields = (), int 'start = 0, int? 'limit = ()) returns SearchItemResponse200|error {
        ...
        map<anydata> queryParam = {"term": term, "item_types": itemTypes, "fields": fields, "search_for_related_items": searchForRelatedItems, "exact_match": exactMatch, "include_fields": includeFields, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function searchItemByField(string term, string fieldType, string fieldKey, boolean exactMatch = false, boolean? returnItemIds = (), int? 'start = (), int? 'limit = ()) returns SearchItemByFieldResponse200|error {
        ...
        map<anydata> queryParam = {"term": term, "field_type": fieldType, "exact_match": exactMatch, "field_key": fieldKey, "return_item_ids": returnItemIds, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function getLeads(int? 'limit = (), int? 'start = (), string? archivedStatus = ()) returns GetLeadsResponse200|error {
        ...
        map<anydata> queryParam = {"limit": 'limit, "start": 'start, "archived_status": archivedStatus, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteLead(string id) returns LeadIdResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        LeadIdResponse200 response = check self.clientEp-> delete(path, request, targetType = LeadIdResponse200);
        return response;
    }
    # Update a lead
    #
    ...
    remote isolated function getMailMessage(int id, decimal includeBody = 1) returns MailMessageResponse200|error {
        ...
        map<anydata> queryParam = {"include_body": includeBody, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function getMailThreads(string folder, int 'start = 0, int? 'limit = ()) returns GetMailThreadsResponse200|error {
        ...
        map<anydata> queryParam = {"folder": folder, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteMailThread(int id) returns DeleteMailThreadResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteMailThreadResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteMailThreadResponse200);
        return response;
    }
    ...
    remote isolated function getNotes(int? userId = (), string? leadId = (), int? dealId = (), int? personId = (), int? orgId = (), int 'start = 0, int? 'limit = (), string? sort = (), string? startDate = (), string? endDate = (), decimal? pinnedToLeadFlag = (), decimal? pinnedToDealFlag = (), decimal? pinnedToOrganizationFlag = (), decimal? pinnedToPersonFlag = ()) returns GetNotesResponse200|error {
        ...
        map<anydata> queryParam = {"user_id": userId, "lead_id": leadId, "deal_id": dealId, "person_id": personId, "org_id": orgId, "start": 'start, "limit": 'limit, "sort": sort, "start_date": startDate, "end_date": endDate, "pinned_to_lead_flag": pinnedToLeadFlag, "pinned_to_deal_flag": pinnedToDealFlag, "pinned_to_organization_flag": pinnedToOrganizationFlag, "pinned_to_person_flag": pinnedToPersonFlag, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteNote(int id) returns DeleteNoteResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteNoteResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteNoteResponse200);
        return response;
    }
    ...
    remote isolated function deleteComment(int id, string commentId) returns DeleteCommentResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteCommentResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteCommentResponse200);
        return response;
    }
    # Get all note fields
    #
    ...
    remote isolated function getOrganizations(int? userId = (), int? filterId = (), string? firstChar = (), int 'start = 0, int? 'limit = (), string? sort = ()) returns GetOrganizationsResponse200|error {
        ...
        map<anydata> queryParam = {"user_id": userId, "filter_id": filterId, "first_char": firstChar, "start": 'start, "limit": 'limit, "sort": sort, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteOrganizations(string ids) returns DeleteOrganizationsResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteOrganizationsResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteOrganizationsResponse200);
        return response;
    }
    ...
    remote isolated function searchOrganization(string term, string? fields = (), boolean? exactMatch = (), int 'start = 0, int? 'limit = ()) returns SearchOrganizationResponse200|error {
        ...
        map<anydata> queryParam = {"term": term, "fields": fields, "exact_match": exactMatch, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function getOrganizationByName(string term, int 'start = 0, int? 'limit = ()) returns json|error {
        ...
        map<anydata> queryParam = {"term": term, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
        json response = check self.clientEp-> get(path, targetType = json);
        return response;
    }
    ...
    remote isolated function deleteOrganization(int id) returns DeleteOrganizationResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteOrganizationResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteOrganizationResponse200);
        return response;
    }
    ...
    remote isolated function getOrganizationDeals(int id, int 'start = 0, int? 'limit = (), string status = "all_not_deleted", string? sort = (), decimal? onlyPrimaryAssociation = ()) returns GetAssociatedDealsResponse200|error {
        ...
        map<anydata> queryParam = {"start": 'start, "limit": 'limit, "status": status, "sort": sort, "only_primary_association": onlyPrimaryAssociation, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteOrganizationFollower(int id, int followerId) returns DeleteOrganizationFollowerResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteOrganizationFollowerResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteOrganizationFollowerResponse200);
        return response;
    }
    ...
    remote isolated function getOrganizationRelationships(int orgId) returns GetOrganizationRelationshipsResponse200|error {
        ...
        map<anydata> queryParam = {"org_id": orgId, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteOrganizationRelationship(int id) returns DeleteOrganizationRelationshipResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteOrganizationRelationshipResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteOrganizationRelationshipResponse200);
        return response;
    }
    ...
    remote isolated function deletePersons(string? ids = ()) returns DeletePersonsResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeletePersonsResponse200 response = check self.clientEp-> delete(path, request, targetType = DeletePersonsResponse200);
        return response;
    }
    # Search persons
    #
    ...
    remote isolated function searchPersons(string term, string? fields = (), boolean? exactMatch = (), int? organizationId = (), string? includeFields = (), int 'start = 0, int? 'limit = ()) returns SearchPersonsResponse200|error {
        ...
        map<anydata> queryParam = {"term": term, "fields": fields, "exact_match": exactMatch, "organization_id": organizationId, "include_fields": includeFields, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function findPersonByName(string term, int? orgId = (), int 'start = 0, int? 'limit = (), decimal? searchByEmail = ()) returns json|error {
        ...
        map<anydata> queryParam = {"term": term, "org_id": orgId, "start": 'start, "limit": 'limit, "search_by_email": searchByEmail, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
        json response = check self.clientEp-> get(path, targetType = json);
        return response;
    }
    ...
    remote isolated function deletePerson(int id) returns DeletePersonResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeletePersonResponse200 response = check self.clientEp-> delete(path, request, targetType = DeletePersonResponse200);
        return response;
    }
    ...
    remote isolated function getPersonDeals(int id, int 'start = 0, int? 'limit = (), string status = "all_not_deleted", string? sort = ()) returns GetAssociatedDealsResponse200|error {
        ...
        map<anydata> queryParam = {"start": 'start, "limit": 'limit, "status": status, "sort": sort, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
        GetAssociatedDealsResponse200 response = check self.clientEp-> get(path, targetType = GetAssociatedDealsResponse200);
        return response;
    }
    ...
    #
    # + id - ID of a person
    # + payload - AddPersonPicture request
    # + return - success
    remote isolated function addPersonPicture(int id, AddPersonPictureRequest payload) returns AddPersonPictureResponse200|error {
        string  path = string `/persons/${id}/picture`;
        map<anydata> queryParam = {"api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
        http:Request request = new;
        AddPersonPictureResponse200 response = check self.clientEp->post(path, request, targetType=AddPersonPictureResponse200);
        return response;
    }
    ...
    remote isolated function getPipeline(int id, string? totalsConvertCurrency = ()) returns GetPipelineResponse200|error {
        ...
        map<anydata> queryParam = {"totals_convert_currency": totalsConvertCurrency, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deletePipeline(int id) returns DeletePipelineResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeletePipelineResponse200 response = check self.clientEp-> delete(path, request, targetType = DeletePipelineResponse200);
        return response;
    }
    ...
    remote isolated function getPipelineConversionStatistics(int id, string startDate, string endDate, int? userId = ()) returns GetPipelineConversionStatisticsResponse200|error {
        ...
        map<anydata> queryParam = {"start_date": startDate, "end_date": endDate, "user_id": userId, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function getPipelineDeals(int id, int? filterId = (), int? userId = (), decimal? everyone = (), int? stageId = (), int 'start = 0, int? 'limit = (), decimal? getSummary = (), string? totalsConvertCurrency = ()) returns GetStageDealsResponse200|error {
        ...
        map<anydata> queryParam = {"filter_id": filterId, "user_id": userId, "everyone": everyone, "stage_id": stageId, "start": 'start, "limit": 'limit, "get_summary": getSummary, "totals_convert_currency": totalsConvertCurrency, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function getProducts(int? userId = (), int[]? ids = (), string? firstChar = (), boolean? getSummary = (), int 'start = 0, int? 'limit = ()) returns GetProductsResponse200|error {
        ...
        map<anydata> queryParam = {"user_id": userId, "ids": ids, "first_char": firstChar, "get_summary": getSummary, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function searchProducts(string term, string? fields = (), boolean? exactMatch = (), string? includeFields = (), int 'start = 0, int? 'limit = ()) returns SearchProductsResponse200|error {
        ...
        map<anydata> queryParam = {"term": term, "fields": fields, "exact_match": exactMatch, "include_fields": includeFields, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function findProductsByName(string term, string? currency = (), int 'start = 0, int? 'limit = ()) returns FindProductsByNameResponse200|error {
        ...
        map<anydata> queryParam = {"term": term, "currency": currency, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteProduct(int id) returns DeleteProductResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteProductResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteProductResponse200);
        return response;
    }
    ...
    remote isolated function getProductDeals(int id, int 'start = 0, int? 'limit = (), string status = "all_not_deleted") returns BasicDeal|error {
        ...
        map<anydata> queryParam = {"start": 'start, "limit": 'limit, "status": status, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteProductFollower(int id, int followerId) returns DeleteProductFollowerResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteProductFollowerResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteProductFollowerResponse200);
        return response;
    }
    # List permitted users
    #
    ...
    remote isolated function addProductField(Body payload) returns GetProductFieldResponse200|error {
        string  path = string `/productFields`;
        map<anydata> queryParam = {"api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
        http:Request request = new;
    ...
    remote isolated function deleteProductFields(string ids) returns DeleteProductFieldsResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteProductFieldsResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteProductFieldsResponse200);
        return response;
    }
    ...
    remote isolated function deleteProductField(int id) returns DeleteProductFieldResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteProductFieldResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteProductFieldResponse200);
        return response;
    }
    # Get recents
    #
    ...
    remote isolated function getRecents(string sinceTimestamp, string? items = (), int 'start = 0, int? 'limit = ()) returns GetRecentsResponse200|error {
        ...
        map<anydata> queryParam = {"since_timestamp": sinceTimestamp, "items": items, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteRole(int id) returns DeleteRoleResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteRoleResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteRoleResponse200);
        return response;
    }
    ...
    remote isolated function search(string term, string? itemType = (), int 'start = 0, int? 'limit = (), decimal? exactMatch = ()) returns json|error {
        ...
        map<anydata> queryParam = {"term": term, "item_type": itemType, "start": 'start, "limit": 'limit, "exact_match": exactMatch, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
        json response = check self.clientEp-> get(path, targetType = json);
        return response;
    }
    ...
    remote isolated function searchByField(string term, string fieldType, string fieldKey, decimal? exactMatch = (), string? returnFieldKey = (), decimal? returnItemIds = (), int 'start = 0, int? 'limit = ()) returns json|error {
        ...
        map<anydata> queryParam = {"term": term, "exact_match": exactMatch, "field_type": fieldType, "field_key": fieldKey, "return_field_key": returnFieldKey, "return_item_ids": returnItemIds, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
        json response = check self.clientEp-> get(path, targetType = json);
        return response;
    }
    ...
    remote isolated function getStages(int? pipelineId = ()) returns GetStagesResponse200|error {
        ...
        map<anydata> queryParam = {"pipeline_id": pipelineId, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function deleteStages(string ids) returns DeleteStagesResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteStagesResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteStagesResponse200);
        return response;
    }
    # Get one stage
    #
    ...
    remote isolated function deleteStage(int id) returns DeleteStageResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        DeleteStageResponse200 response = check self.clientEp-> delete(path, request, targetType = DeleteStageResponse200);
        return response;
    }
    ...
    remote isolated function getStageDeals(int id, int? filterId = (), int? userId = (), decimal? everyone = (), int 'start = 0, int? 'limit = ()) returns GetStageDealsResponse200|error {
        ...
        map<anydata> queryParam = {"filter_id": filterId, "user_id": userId, "everyone": everyone, "start": 'start, "limit": 'limit, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
        GetStageDealsResponse200 response = check self.clientEp-> get(path, targetType = GetStageDealsResponse200);
        return response;
    }
    ...
    remote isolated function deleteSubscription(int id) returns SubscriptionsIdResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        SubscriptionsIdResponse200 response = check self.clientEp-> delete(path, request, targetType = SubscriptionsIdResponse200);
        return response;
    }
    ...
    remote isolated function getTeams(string orderBy = "id", decimal skipUsers = 1) returns TeamsResponse200|error {
        ...
        map<anydata> queryParam = {"order_by": orderBy, "skip_users": skipUsers, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function getTeam(int id, decimal skipUsers = 1) returns TeamResponse200|error {
        ...
        map<anydata> queryParam = {"skip_users": skipUsers, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function findUsersByName(string term, decimal searchByEmail = 1) returns UsersResponse200|error {
        ...
        map<anydata> queryParam = {"term": term, "search_by_email": searchByEmail, "api_token": self.apiKeys["api_token"]};
        path = path + check getPathForQueryParam(queryParam);
        UsersResponse200 response = check self.clientEp-> get(path, targetType = UsersResponse200);
        return response;
    }
    ...
    remote isolated function deleteWebhook(int id) returns BaseResponse200|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        BaseResponse200 response = check self.clientEp-> delete(path, request, targetType = BaseResponse200);
        return response;
    }
}
