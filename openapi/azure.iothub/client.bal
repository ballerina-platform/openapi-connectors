...
public isolated client class Client {
    ...
    remote isolated function operationsList(string apiVersion) returns OperationListResult|error {
        string resourcePath = string `/providers/Microsoft.Devices/operations`;
    ...
    remote isolated function iothubresourceListbysubscription(string apiVersion, string subscriptionId) returns IotHubDescriptionListResult|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/providers/Microsoft.Devices/IotHubs`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        IotHubDescriptionListResult response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    remote isolated function iothubresourceChecknameavailability(string apiVersion, string subscriptionId, OperationInputs payload) returns IotHubNameAvailabilityInfo|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/providers/Microsoft.Devices/checkNameAvailability`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        IotHubNameAvailabilityInfo response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    remote isolated function resourceprovidercommonGetsubscriptionquota(string subscriptionId, string apiVersion) returns UserSubscriptionQuotaListResult|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/providers/Microsoft.Devices/usages`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        UserSubscriptionQuotaListResult response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    remote isolated function iothubresourceListbyresourcegroup(string apiVersion, string subscriptionId, string resourceGroupName) returns IotHubDescriptionListResult|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        IotHubDescriptionListResult response = check self.clientEp->get(resourcePath);
        return response;
    ...
    remote isolated function iothubManualfailover(string iotHubName, string subscriptionId, string resourceGroupName, string apiVersion, FailoverInput payload) returns http:Response|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(iotHubName)}/failover`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
    ...
    remote isolated function iothubresourceTestallroutes(string iotHubName, string subscriptionId, string resourceGroupName, string apiVersion, TestAllRoutesInput payload) returns TestAllRoutesResult|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(iotHubName)}/routing/routes/$testall`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        TestAllRoutesResult response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    # Test the new route
    #
    ...
    remote isolated function iothubresourceTestroute(string iotHubName, string subscriptionId, string resourceGroupName, string apiVersion, TestRouteInput payload) returns TestRouteResult|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(iotHubName)}/routing/routes/$testnew`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        TestRouteResult response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    remote isolated function iothubresourceGetendpointhealth(string subscriptionId, string resourceGroupName, string iotHubName, string apiVersion) returns EndpointHealthDataListResult|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(iotHubName)}/routingEndpointsHealth`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        EndpointHealthDataListResult response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    remote isolated function iothubresourceGet(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName) returns IotHubDescription|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        IotHubDescription response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    remote isolated function iothubresourceCreateorupdate(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName, IotHubDescription payload, string? ifMatch = ()) returns IotHubDescription|error {
        ...
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        IotHubDescription response = check self.clientEp->put(resourcePath, request, httpHeaders);
        return response;
    }
    # Delete an IoT hub
    #
    ...
    remote isolated function iothubresourceDelete(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName) returns IotHubDescription|error? {
        ...
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        IotHubDescription? response = check self.clientEp-> delete(resourcePath);
        return response;
    }
    ...
    remote isolated function iothubresourceUpdate(string subscriptionId, string resourceGroupName, string resourceName, string apiVersion, TagsResource payload) returns IotHubDescription|error {
        ...
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        IotHubDescription response = check self.clientEp->patch(resourcePath, request);
        return response;
    }
    ...
    remote isolated function iothubresourceGetkeysforkeyname(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName, string keyName) returns SharedAccessSignatureAuthorizationRule|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/IotHubKeys/${getEncodedUri(keyName)}/listkeys`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        http:Request request = new;
        //TODO: Update the request as needed;
        SharedAccessSignatureAuthorizationRule response = check self.clientEp-> post(resourcePath, request);
        return response;
    }
    ...
    remote isolated function iothubresourceGetstats(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName) returns RegistryStatistics|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/IotHubStats`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        RegistryStatistics response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    remote isolated function certificatesListbyiothub(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName) returns CertificateListDescription|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/certificates`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        CertificateListDescription response = check self.clientEp->get(resourcePath);
        return response;
    }
    # Get the certificate.
    #
    ...
    remote isolated function certificatesGet(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName, string certificateName) returns CertificateDescription|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/certificates/${getEncodedUri(certificateName)}`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        CertificateDescription response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    remote isolated function certificatesCreateorupdate(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName, string certificateName, CertificateBodyDescription payload, string? ifMatch = ()) returns CertificateDescription|error {
        ...
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        CertificateDescription response = check self.clientEp->put(resourcePath, request, httpHeaders);
        return response;
    }
    ...
    remote isolated function certificatesGenerateverificationcode(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName, string certificateName, string ifMatch) returns CertificateWithNonceDescription|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/certificates/${getEncodedUri(certificateName)}/generateVerificationCode`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        map<any> headerValues = {"If-Match": ifMatch};
        map<string|string[]> httpHeaders = getMapForHeaders(headerValues);
        http:Request request = new;
        //TODO: Update the request as needed;
        CertificateWithNonceDescription response = check self.clientEp->post(resourcePath, request, httpHeaders);
        return response;
    }
    ...
    remote isolated function certificatesVerify(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName, string certificateName, string ifMatch, CertificateVerificationDescription payload) returns CertificateDescription|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/certificates/${getEncodedUri(certificateName)}/verify`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        map<any> headerValues = {"If-Match": ifMatch};
        map<string|string[]> httpHeaders = getMapForHeaders(headerValues);
        ...
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        CertificateDescription response = check self.clientEp->post(resourcePath, request, httpHeaders);
        return response;
    }
    ...
    remote isolated function iothubresourceListeventhubconsumergroups(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName, string eventHubEndpointName) returns EventHubConsumerGroupsListResult|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/eventHubEndpoints/${getEncodedUri(eventHubEndpointName)}/ConsumerGroups`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        EventHubConsumerGroupsListResult response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    remote isolated function iothubresourceGeteventhubconsumergroup(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName, string eventHubEndpointName, string name) returns EventHubConsumerGroupInfo|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/eventHubEndpoints/${getEncodedUri(eventHubEndpointName)}/ConsumerGroups/${getEncodedUri(name)}`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        EventHubConsumerGroupInfo response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    remote isolated function iothubresourceCreateeventhubconsumergroup(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName, string eventHubEndpointName, string name) returns EventHubConsumerGroupInfo|error {
        ...
        http:Request request = new;
        //TODO: Update the request as needed;
        EventHubConsumerGroupInfo response = check self.clientEp-> put(resourcePath, request);
        return response;
    }
    ...
    remote isolated function iothubresourceExportdevices(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName, ExportDevicesRequest payload) returns JobResponse|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/exportDevices`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        JobResponse response = check self.clientEp->post(resourcePath, request);
        return response;
    }
    ...
    remote isolated function iothubresourceImportdevices(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName, ImportDevicesRequest payload) returns JobResponse|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/importDevices`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
    ...
    remote isolated function iothubresourceListjobs(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName) returns JobResponseListResult|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/jobs`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        JobResponseListResult response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    remote isolated function iothubresourceGetjob(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName, string jobId) returns JobResponse|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/jobs/${getEncodedUri(jobId)}`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
    ...
    remote isolated function iothubresourceListkeys(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName) returns SharedAccessSignatureAuthorizationRuleListResult|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/listkeys`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        http:Request request = new;
        //TODO: Update the request as needed;
        SharedAccessSignatureAuthorizationRuleListResult response = check self.clientEp-> post(resourcePath, request);
        return response;
    }
    ...
    remote isolated function iothubresourceGetquotametrics(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName) returns IotHubQuotaMetricInfoListResult|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/quotaMetrics`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        IotHubQuotaMetricInfoListResult response = check self.clientEp->get(resourcePath);
        return response;
    }
    ...
    remote isolated function iothubresourceGetvalidskus(string apiVersion, string subscriptionId, string resourceGroupName, string resourceName) returns IotHubSkuDescriptionListResult|error {
        string resourcePath = string `/subscriptions/${getEncodedUri(subscriptionId)}/resourceGroups/${getEncodedUri(resourceGroupName)}/providers/Microsoft.Devices/IotHubs/${getEncodedUri(resourceName)}/skus`;
        map<anydata> queryParam = {"api-version": apiVersion};
        resourcePath = resourcePath + check getPathForQueryParam(queryParam);
        IotHubSkuDescriptionListResult response = check self.clientEp->get(resourcePath);
        return response;
    }
}
