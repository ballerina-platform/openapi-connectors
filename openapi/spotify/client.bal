...
# Client endpoint for Spotify Web API
#
...
public client class Client {
    ...
    remote isolated function getPlaylistById(@display {label: "Playlist Id"} string playlist_id, @display {label: "Market"} string? market = (), @display {label: "Fields to Return"} string? fields = (), @display {label: "Additional Types"} string? additionalTypes = ()) returns PlaylistObject|error {
    ...
    remote isolated function getPlaylistTracks(@display {label: "Playlist Id"} string playlist_id, @display {label: "Market"} string market, @display {label: "Fields to Return"} string? fields = (), @display {label: "Limit"} int? 'limit = (), @display {label: "Offset"} int? offset = (), string? additionalTypes = ()) returns PlaylistTrackDetails|error {
