...
public isolated client class Client {
    ...
    remote isolated function getFulfillmentPolicies(string marketplaceId) returns FulfillmentPolicyResponse|error {
        string  path = string `/fulfillment_policy`;
        map<anydata> queryParam = {"marketplace_id": marketplaceId};
        path = path + check getPathForQueryParam(queryParam);
        FulfillmentPolicyResponse response = check self.clientEp-> get(path, targetType = FulfillmentPolicyResponse);
        return response;
    }
    ...
    remote isolated function createFulfillmentPolicy(FulfillmentPolicyRequest payload) returns SetFulfillmentPolicyResponse|error {
        ...
        SetFulfillmentPolicyResponse response = check self.clientEp->post(path, request, targetType=SetFulfillmentPolicyResponse);
        return response;
    }
    ...
    remote isolated function getFulfillmentPolicy(string fulfillmentPolicyId) returns FulfillmentPolicy|error {
        string  path = string `/fulfillment_policy/${fulfillmentPolicyId}`;
        FulfillmentPolicy response = check self.clientEp-> get(path, targetType = FulfillmentPolicy);
        return response;
    }
    ...
    remote isolated function updateFulfillmentPolicy(string fulfillmentPolicyId, FulfillmentPolicyRequest payload) returns SetFulfillmentPolicyResponse|error {
        ...
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody);
        SetFulfillmentPolicyResponse response = check self.clientEp->put(path, request, targetType=SetFulfillmentPolicyResponse);
        return response;
    }
    ...
    remote isolated function getFulfillmentPolicyByName(string marketplaceId, string name) returns FulfillmentPolicy|error {
        string  path = string `/fulfillment_policy/get_by_policy_name`;
    ...
    remote isolated function getPaymentPolicies(string marketplaceId) returns PaymentPolicyResponse|error {
        string  path = string `/payment_policy`;
        map<anydata> queryParam = {"marketplace_id": marketplaceId};
        path = path + check getPathForQueryParam(queryParam);
        PaymentPolicyResponse response = check self.clientEp-> get(path, targetType = PaymentPolicyResponse);
        return response;
    }
    ...
    remote isolated function createPaymentPolicy(PaymentPolicyRequest payload) returns SetPaymentPolicyResponse|error {
        ...
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody);
        SetPaymentPolicyResponse response = check self.clientEp->post(path, request, targetType=SetPaymentPolicyResponse);
        return response;
    }
    ...
    remote isolated function getPaymentPolicy(string paymentPolicyId) returns PaymentPolicy|error {
        string  path = string `/payment_policy/${paymentPolicyId}`;
        PaymentPolicy response = check self.clientEp-> get(path, targetType = PaymentPolicy);
        return response;
    }
    ...
    remote isolated function updatePaymentPolicy(string paymentPolicyId, PaymentPolicyRequest payload) returns SetPaymentPolicyResponse|error {
        ...
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody);
        SetPaymentPolicyResponse response = check self.clientEp->put(path, request, targetType=SetPaymentPolicyResponse);
        return response;
    }
    ...
    remote isolated function getPaymentPolicyByName(string marketplaceId, string name) returns PaymentPolicy|error {
        string  path = string `/payment_policy/get_by_policy_name`;
        map<anydata> queryParam = {"marketplace_id": marketplaceId, "name": name};
        path = path + check getPathForQueryParam(queryParam);
        PaymentPolicy response = check self.clientEp-> get(path, targetType = PaymentPolicy);
        return response;
    ...
    remote isolated function getPaymentsProgram(string marketplaceId, string paymentsProgramType) returns PaymentsProgramResponse|error {
        string  path = string `/payments_program/${marketplaceId}/${paymentsProgramType}`;
        PaymentsProgramResponse response = check self.clientEp-> get(path, targetType = PaymentsProgramResponse);
        return response;
    }
    ...
    remote isolated function getPaymentsProgramOnboarding(string marketplaceId, string paymentsProgramType) returns PaymentsProgramOnboardingResponse|error {
        string  path = string `/payments_program/${marketplaceId}/${paymentsProgramType}/onboarding`;
        PaymentsProgramOnboardingResponse response = check self.clientEp-> get(path, targetType = PaymentsProgramOnboardingResponse);
        return response;
    }
    ...
    remote isolated function getPrivileges() returns SellingPrivileges|error {
        string  path = string `/privilege`;
        SellingPrivileges response = check self.clientEp-> get(path, targetType = SellingPrivileges);
        return response;
    }
    ...
    remote isolated function getOptedInPrograms() returns Programs|error {
        string  path = string `/program/get_opted_in_programs`;
        Programs response = check self.clientEp-> get(path, targetType = Programs);
        return response;
    }
    ...
    remote isolated function optInToProgram(Program payload) returns json|error {
        string  path = string `/program/opt_in`;
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody);
    ...
    remote isolated function optOutOfProgram(Program payload) returns json|error {
        string  path = string `/program/opt_out`;
        http:Request request = new;
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody);
        json response = check self.clientEp->post(path, request, targetType=json);
    ...
    remote isolated function getRateTables(string? countryCode = ()) returns RateTableResponse|error {
        string  path = string `/rate_table`;
        map<anydata> queryParam = {"country_code": countryCode};
        path = path + check getPathForQueryParam(queryParam);
        RateTableResponse response = check self.clientEp-> get(path, targetType = RateTableResponse);
        return response;
    }
    ...
    remote isolated function getReturnPolicies(string marketplaceId) returns ReturnPolicyResponse|error {
        string  path = string `/return_policy`;
        map<anydata> queryParam = {"marketplace_id": marketplaceId};
        path = path + check getPathForQueryParam(queryParam);
    ...
    remote isolated function createReturnPolicy(ReturnPolicyRequest payload) returns SetReturnPolicyResponse|error {
        ...
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody);
        SetReturnPolicyResponse response = check self.clientEp->post(path, request, targetType=SetReturnPolicyResponse);
        return response;
    }
    ...
    remote isolated function getReturnPolicy(string returnPolicyId) returns ReturnPolicy|error {
        string  path = string `/return_policy/${returnPolicyId}`;
        ReturnPolicy response = check self.clientEp-> get(path, targetType = ReturnPolicy);
        return response;
    }
    ...
    remote isolated function updateReturnPolicy(string returnPolicyId, ReturnPolicyRequest payload) returns SetReturnPolicyResponse|error {
        ...
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody);
        SetReturnPolicyResponse response = check self.clientEp->put(path, request, targetType=SetReturnPolicyResponse);
        return response;
    }
    ...
    remote isolated function getReturnPolicyByName(string marketplaceId, string name) returns ReturnPolicy|error {
        string  path = string `/return_policy/get_by_policy_name`;
        map<anydata> queryParam = {"marketplace_id": marketplaceId, "name": name};
        path = path + check getPathForQueryParam(queryParam);
        ReturnPolicy response = check self.clientEp-> get(path, targetType = ReturnPolicy);
        return response;
    ...
    remote isolated function getSalesTax(string countryCode, string jurisdictionId) returns SalesTax|error {
        string  path = string `/sales_tax/${countryCode}/${jurisdictionId}`;
        SalesTax response = check self.clientEp-> get(path, targetType = SalesTax);
        return response;
    }
    ...
    remote isolated function getSalesTaxes(string countryCode) returns SalesTaxes|error {
        string  path = string `/sales_tax`;
        map<anydata> queryParam = {"country_code": countryCode};
        path = path + check getPathForQueryParam(queryParam);
        SalesTaxes response = check self.clientEp-> get(path, targetType = SalesTaxes);
        return response;
    }
    ...
    remote isolated function getKYC() returns KycResponse|error {
        string  path = string `/kyc`;
        KycResponse response = check self.clientEp-> get(path, targetType = KycResponse);
        return response;
    }
}
