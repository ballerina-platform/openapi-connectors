...
public type RequestCodeRequestBody record {
    ...
    RequestCodeRequestBodyMethod method;
...
public type CheckContactRequestBody record {
    ...
    CheckContactRequestBodyBlocking blocking?;
...
public type SendMessageRequestBody record {
    ...
    SendMessageRequestBodyRecipientType recipient_type?;
    # Text
    Text text?;
...
public enum MetaApiStatus {
    METAAPISTATUS_DEPRECATED = "deprecated",
    METAAPISTATUS_EXPERIMENTAL = "experimental",
    METAAPISTATUS_STABLE = "stable"
}

public enum RequestCodeRequestBodyMethod {
    REQUESTCODEREQUESTBODYMETHOD_SMS = "sms",
    REQUESTCODEREQUESTBODYMETHOD_VOICE = "voice"
}

public enum CheckContactRequestBodyBlocking {
    CHECKCONTACTREQUESTBODYBLOCKING_NOWAIT = "no_wait",
    CHECKCONTACTREQUESTBODYBLOCKING_WAIT = "wait"
}

public enum WebhookSystemType {
    WEBHOOKSYSTEMTYPE_GROUPCREATED = "group_created",
    WEBHOOKSYSTEMTYPE_GROUPUSERPROMOTED = "group_user_promoted",
    WEBHOOKSYSTEMTYPE_GROUPUSERDEMOTED = "group_user_demoted",
    WEBHOOKSYSTEMTYPE_GROUPUSERJOINED = "group_user_joined",
    WEBHOOKSYSTEMTYPE_GROUPUSERLEFT = "group_user_left",
    WEBHOOKSYSTEMTYPE_GROUPSUBJECTCHANGED = "group_subject_changed",
    WEBHOOKSYSTEMTYPE_GROUPDESCRIPTIONCHANGED = "group_description_changed",
    WEBHOOKSYSTEMTYPE_GROUPICONCHANGED = "group_icon_changed",
    WEBHOOKSYSTEMTYPE_GROUPICONDELETED = "group_icon_deleted",
    WEBHOOKSYSTEMTYPE_GROUPINVITELINKREVOKED = "group_invite_link_revoked",
    WEBHOOKSYSTEMTYPE_USERIDENTITYCHANGED = "user_identity_changed",
    WEBHOOKSYSTEMTYPE_GROUPUSERCHANGEDNUMBER = "group_user_changed_number",
    WEBHOOKSYSTEMTYPE_GROUPERRORFETCHINGPHOTO = "group_error_fetching_photo",
    WEBHOOKSYSTEMTYPE_GROUPERRORADDINGUSERS = "group_error_adding_users",
    WEBHOOKSYSTEMTYPE_GROUPERRORADDINGUSER = "group_error_adding_user",
    WEBHOOKSYSTEMTYPE_GROUPERRORFULLADDINGUSERS = "group_error_full_adding_users",
    WEBHOOKSYSTEMTYPE_GROUPERRORREMOVINGUSER = "group_error_removing_user",
    WEBHOOKSYSTEMTYPE_BROADCASTLISTCREATED = "broadcast_list_created",
    WEBHOOKSYSTEMTYPE_GROUPENDED = "group_ended",
    WEBHOOKSYSTEMTYPE_GROUPERRORBLOCKEDADDINGUSER = "group_error_blocked_adding_user"
}

public enum WebhookStatusStatus {
    WEBHOOKSTATUSSTATUS_SENT = "sent",
    WEBHOOKSTATUSSTATUS_DELIVERED = "delivered",
    WEBHOOKSTATUSSTATUS_READ = "read",
    WEBHOOKSTATUSSTATUS_FAILED = "failed",
    WEBHOOKSTATUSSTATUS_DELETED = "deleted"
}

public enum SendMessageRequestBodyRecipientType {
    SENDMESSAGEREQUESTBODYRECIPIENTTYPE_INDIVIDUAL = "individual",
    SENDMESSAGEREQUESTBODYRECIPIENTTYPE_GROUP = "group"
}

public enum LanguagePolicy {
    LANGUAGEPOLICY_FALLBACK = "fallback",
    LANGUAGEPOLICY_DETERMINISTIC = "deterministic"
}

public enum CheckContactStatus {
    CHECKCONTACTSTATUS_PROCESSING = "processing",
    CHECKCONTACTSTATUS_VALID = "valid",
    CHECKCONTACTSTATUS_INVALID = "invalid"
}
