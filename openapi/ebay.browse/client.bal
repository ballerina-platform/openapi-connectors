...
public client class Client {
    ...
    # + payload - Compatibility check input payload
    # + return - OK
    ...
    # Add item
    # 
    # + payload - Add card item input payload
    # + return - OK
    ...
    # Remove item
    # 
    # + payload - Remove cart item input payload.
    # + return - OK
    ...
    # Update quantity
    # 
    # + payload - Update cart item input payload.
    # + return - OK
