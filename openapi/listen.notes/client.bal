...
public isolated client class Client {
    ...
    public isolated function init(ApiKeysConfig apiKeyConfig, ConnectionConfig config =  {}, string serviceUrl = "https://listen-api.listennotes.com/api/v2") returns error? {
