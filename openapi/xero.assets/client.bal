...
public isolated client class Client {
    ...
    remote isolated function createAssetType(string xeroTenantId, AssetType payload) returns AssetType|error {
        ...
        AssetType response = check self.clientEp->post(resourcePath, request, headers = httpHeaders);
        return response;
    }
    ...
    remote isolated function createAsset(string xeroTenantId, Asset payload) returns Asset|error {
        ...
        json jsonBody = check payload.cloneWithType(json);
        request.setPayload(jsonBody, "application/json");
        Asset response = check self.clientEp->post(resourcePath, request, headers = httpHeaders);
        return response;
    }
